...
import com.duty.weibotoy.data.WeiboTimelineResponse
...
private class FakeMyModelRepository : DataRepository {
  ...
  override suspend fun fetchWeiboComments(statusId: String, maxId: Long?, maxIdType: Int): com.duty.weibotoy.data.WeiboCommentsResponse? = null
  override suspend fun fetchWeiboCommentChildren(commentId: Long, maxId: Long, maxIdType: Int): com.duty.weibotoy.data.WeiboCommentChildrenResponse? = null
  override suspend fun fetchWeiboReposts(statusId: String, page: Int): com.duty.weibotoy.data.WeiboRepostsResponse? = null
  override suspend fun fetchWeiboAttitudes(statusId: String, page: Int): com.duty.weibotoy.data.WeiboAttitudesResponse? = null
